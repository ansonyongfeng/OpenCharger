...
@property (copy, nonatomic) OCSuccessBlock updatedValueBlock;
@property (copy, nonatomic) OCSuccessBlock powerOnBlock;
@property (copy, nonatomic) OCSuccessBlock discoveredCharacteristicsBlock;

@end

@implementation OpenChargerSDK
...
- (void)peripheralDidUpdateRSSI:(CBPeripheral *)peripheral error:(NSError *)error{
    if (!error) {
        //NSLog(@"this RSSI%@", peripheral.RSSI);
    }
}
